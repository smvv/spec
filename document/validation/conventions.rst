...
.. note::
   ...
   But it provides an effective means of communication and is amenable to mathematical proof.
...
.. note::
   ...
   If so, it has the same type as the body.
   The result type of the instruction must match the block's annotation :math:`t^?`.
